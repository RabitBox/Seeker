...
Vector3 MatrixRotation3D(const Vector3 &this_position, const Vector3 &center_position, const AVector3 &rotation);		// X,Y,Zの回転
//Vector3 MatrixRotationYPR(const Vector3 &this_position, const Vector3 &center_position, const AVector3 &rotation);		// Yaw, Pitch, Rollの順で回転する
